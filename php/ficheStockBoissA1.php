            ...
            <div class="row" style="border-bottom:1px solid black;margin-bottom:2px">
                ...
                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8 text-center" >
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-top:40px;">
                        <h1 class="text-center text-uppercase" style="text-align:center; border: 1px solid black">Fiche de stock Dépôt Rélais 2</h1>
        ...
        <div class="container">
            <div class="row spacer" >
                            ...
                            $num++;
                             ...
                             <tr>
                                ...
                                <td class="text-right"><strong><h4><?php 
                                    $req = $bd->query("SELECT SUM(qnteBoiss*pvCasier) AS total FROM prodboiss AS A,catboiss AS B, depot AS C WHERE B.idCatBoiss=A.idCatBoiss AND A.idDepot = C.id AND A.idDepot = 2");
                ...
                <?php
                    ...
                    $req2 = $bd->query("SELECT * FROM users,depot WHERE idDepot = id AND idDepot = 2 AND user_function = 'Chef_Depot_Relais'");
                    $don2=$req2->fetch(); 

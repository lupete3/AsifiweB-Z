<?php
    ...
    $req = $bd->prepare("SELECT  designSauna,date_format(dateSauna,'%d-%m-%Y') as dateSauna,accompte,abonne FROM sauna WHERE  dateSauna LIKE '%$dateJ%'");
        $req->execute();
    ...
    if (isset($_GET['save'])) {
        ...
        $req = $bd->prepare("SELECT  designSauna,date_format(dateSauna,'%d-%m-%Y') as dateSauna,accompte,abonne FROM sauna WHERE  dateSauna BETWEEN ? AND ? ");
                    ...
                    <table class="table table-bordered table-striped spacer">
                        ...
                        <tbody>
                                ...
                                <tr>
                                        ...
                                        <td><?php echo (($don['abonne'] == 0) ? '' : 'Abonnement') ?></td>

<?php
    ...
    if (isset($_GET['id'])) {
      ...
      //  $req=$bd->query("SET NAMES 'utf8'");
        $req=$bd->prepare('SELECT dateDebut,dateFin,qteSauna,puSauna,ptSauna,type FROM sauna,client WHERE sauna.id_client = client.id_client AND idSauna=? ');
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <center>
                            <p style= " margin-left:0px;">
                                <img src="../docs/emoticones/log1.png"  alt="logo" style="width:20%;">
                            </p>
                        </center>        
                    </div>  
                </div>
                                    ...
                                    <tbody>
                                        ...
                                        $num=1;
                                            while($don=$req->fetch(PDO::FETCH_ASSOC)){
                                                ...
                                                $nj= (strtotime($don['dateFin']) - strtotime($don['dateDebut']));

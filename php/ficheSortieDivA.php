<?php
    ...
    if (isset($_GET['save'])) {
        ...
        $req = $bd->prepare("SELECT A.idSortDiv,A.idDiv,date_format(A.dateSortDiv,'%e-%m-%Y à %T') as dateSortDiv,A.qteSortDiv, A.ptSortDiv, A.poste, C.idDiv,C.designation, C.pu FROM sortiediv as A, stockdivers as C WHERE A.idDiv = C.idDiv AND A.dateSortDiv BETWEEN ? AND ? ");
        $req->execute(array($in,$out));
        $req1 = $bd->prepare("SELECT SUM(qteSortDiv*pu) AS total FROM sortiediv as A, stockdivers as C WHERE A.idDiv = C.idDiv AND A.dateSortDiv BETWEEN ? AND ?");
                    ...
                    <table class="table table-bordered table-striped spacer">
                        ...
                        <tbody>
                                ...
                                <tr>
                                       ...
                                       <td class="text-right"><?php echo ($don['qteSortDiv']*$don['pu'].' Fc') ?></td>
                                        <td></td>
                             ...
                             <tr>
                                ...
                                <td class="text-right"><strong><h4><?php
                                        ...
                                        echo(isset($_GET['save'])?number_format($don1['total'],2).' Fc':number_format($don1['total'],0).' Fc');

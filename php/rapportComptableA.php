            ...
            <div id="sect1" class="row" style=" background-color:white; padding-top:20px;">
                ...
                <div class="col-lg-12" style="margin-top:30px; padding:10px; border: 2px solid #b90112; background-color:white; border-radius:50px;">
                    ...
                    <div class="row" style="padding:10px; " > 
                        ...
                        <div class="col-lg-3 col-md-3 " style="">
                            <center>
                                 <a href="economatA1.php" title="Cliquer pour ajouter une Catégorie"><img src="../docs/emoticones/task5.jpg" width="40%" alt="Fiche Boisson" > </a>
                            </center>
                       ...
                       <div class="col-lg-3 col-md-3 " style="">
                        ...
                        <div class="col-lg-3 col-md-3 " style="">
                            ...
                            <legend style="color:black; text-align:center;">Fiche Matériels</legend>
                        </div>
                       

                        <div class="col-lg-3 col-md-3 " style="">
                            <center>
                                 <a href="ficheEntreeCaisse.php" target="_blank">
                                     <img src="../docs/emoticones/task7.png" width="40%" alt="Ajout nourriture" >  </a>
                            </center>
                        ...
                        <div class="col-lg-3 col-md-3 " style="">
                            <center>
                                 <a href="ficheSortieCaisse.php" target="_blank">
                                     <img src="../docs/emoticones/task7.png" width="40%" alt="Ajout nourriture" >  </a>
                            </center>
                        ...
                        <div class="col-lg-3 col-md-3 " style="">
                            <center>
                                 <a href="ficheTableauExploitationMensuelle.php" target="_blank">

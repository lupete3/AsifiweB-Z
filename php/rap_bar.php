...
<html>
    ...
    <body id="">
        ...
        <div id="sect1" class="row" style=" background-color:white; padding-top:20px;">
            ...
            <div class="col-lg-10" style="margin-top:20px; padding:20px; border: 2px solid #b90112; background-color:white; border-radius:50px 50px 50px 50px; box-shadow: 0px 10px 20px;">

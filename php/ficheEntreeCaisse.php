<?php
    ...
    $req = $bd->prepare("SELECT idEntreeCaiss,montantEntree,motifEntree,date_format(dateEntree,'%d-%m-%Y') as dateEntree FROM entreecaisse WHERE dateEntree LIKE '%$dateJ%'");
    $req->execute();
    ...
    if (isset($_GET['save'])) {
        ...
        $req = $bd->prepare("SELECT idEntreeCaiss,montantEntree,motifEntree,date_format(dateEntree,'%d-%m-%Y') as dateEntree FROM entreecaisse WHERE dateEntree BETWEEN ? AND ?");
            ...
            <div class="row" style="border-bottom:1px solid black;margin-bottom:2px">
                ...
                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8" >
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-top:70px;">
                        <h1 class="text-center text-uppercase" style="text-align:center; border:1px solid black">Fiche Entrée Caisse
                    ...
                    <table class="table table-bordered table-striped spacer">
                        ...
                        <tbody>
                                ...
                                <tr>
                                        ...
                                        <td class="text-right"><?php echo $don['montantEntree'].' Fc' ?></td>

		...
		<div class="row">
			<div class="col-md-4">
				...
				<div class="row">
		          ...
		          <div id="boisson" style="margin-top: -50px">
	      	  	...
	      	  	<div class="col-md-12"> 
	      	  		<form action="../facturePdv.php" method="GET" class="was-validated">
	      	  			...
	      	  			<div class="input-group">
		      	  			...
		      	  			<div class="input-group-append">
							    <button type="submit" class="btn btn-primary btn-lg d-inline" data-toggle="tooltip" title="Cliquer pour imprimer la facture de la table séléctionnée">Facturer</button>
							</div>
	      	  			</div>
	      	  		</form>
	      	  	</div>

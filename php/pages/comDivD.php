	...
	<div class="modal fade" id="supBtn" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<form action="deleteComDivD.php" method="POST">
	...
	<div class="modal fade" id="editBtn" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<form action="upComDivD.php" method="POST" class="was-validated">
					<div class="modal-body">
			...
			<div class="col-md-3">
		          ...
		          <?php
		           ...
		           <form action="" method="POST" class="spacer was-validated">
						...
						<button type="submit" class="btn btn-primary btn-block" name="save">Commander</button>
		           </form>
		    </div>
	      <div class="col-md-9">
	      	<div class="row">
	 				...
	 				<table id="tab" class="display table table-bordered table-striped table">
		          	...
		          	<tbody>
		          		<?php
							...
							$req = $bd->query("SELECT A.idComDiv,A.qteComDiv,date_format(A.dateComDiv,'%e-%m-%Y à %T') as dateComDiv,B.designation FROM comDivers as A,stockdivers as B WHERE B.idDiv=A.idDiv AND A.statutComDiv = 'encours' AND poste='$c' ORDER BY idComDiv LIMIT $start,$limit");
							
							$res = $bd->query("SELECT count(*) as total FROM comDivers as A,stockdivers as B WHERE B.idDiv=A.idDiv AND A.statutComDiv = 'encours' AND poste='$c'");
	          ...
	          <div class="row">
	          	 <div class="col-3 offset-9">
	          	 	<nav aria-label="Page navigation example">
			    		...
			    		<li class="page-item">
			    			<a  class="page-link" aria-label="Previous" href="comDivD.php?page=<?php echo $prec;?>">
			    		...
			    		?> 
			    		<li class="page-item <?php echo(($page==$i)?'active':'')?>"><a  class="page-link" href="comDivD.php?page=<?php echo $i;?>"><?php echo $i;?></a></li>
			    		<?php
			    		}?>
			    		<li class="page-item">
			    			<a  class="page-link" aria-label="Next" href="comDivD.php?page=<?php echo $suiv;?>">

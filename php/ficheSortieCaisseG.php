<?php
    ...
    $req = $bd->prepare("SELECT idSortieCaiss,catCharge,montantSortie,motifSortie,date_format(dateSortie,'%d-%m-%Y') as dateSortie,agent FROM sortiecaisse WHERE dateSortie LIKE '%$dateJ%'");
    $req->execute();

        $req1 = $bd->prepare("SELECT SUM(dateSortie) AS total FROM sortiecaisse WHERE dateSortie LIKE '%$dateJ%'");
        $req1->execute();
    ...
    if (isset($_GET['save'])) {
        ...
        $req = $bd->prepare("SELECT idSortieCaiss,catCharge,montantSortie,motifSortie,date_format(dateSortie,'%d-%m-%Y') as dateSortie,agent FROM sortiecaisse WHERE dateSortie BETWEEN ? AND ?");
            ...
            <div class="row" style="border-bottom:1px solid black;margin-bottom:2px">
                ...
                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8" >
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-top:70px;">
                        <h1 class="text-center text-uppercase" style="text-align:center; border:1px solid black">Fiche Sortie Caisse
                    ...
                    <table class="table table-bordered table-striped spacer">
                        ...
                        <tbody>
                                ...
                                <tr>
                                        ...
                                        <td><?php echo $don['catCharge'] ?></td>
                                        <td><?php echo $don['agent'] ?></td>
                                        <td class="text-right"><?php echo $don['montantSortie'].' Fc' ?></td>

            ...
            <div class="row"> 
                ...
                <div class="col-lg-3 col-md-3 " >
                   <div class="col-lg-12 col-md-12 text-right">
                    ...
                    <a class="nav-link" href="rapport.php"><button type="button" class="btn btn-outline-light "><h3> <span class="fa fa-arrow-circle-left "></span> Retour</h3></button></a>
                    </div>
                ...
                <div class="container">
                    <div class="row" style="text-align:center;">
                        <div class="col-md-12 text-center text-uppercase">
                            <h1 style="color:black;  " class="text-center">Rapport Stock Buvette </h1>
                        </div>
                    </div>
                </div>
                <div class="container" style="background-color:white; padding: 10px; border-radius: 50px; border : 2px solid #b90112">
                     <div class="col-lg-12">
                    
                         
                        <div class="col-lg-3 col-md-3" style="">
                            <center>
                                 <a href="ficheVenteBuvetteJourG.php" target="_blank" title="Cliquer pour ajouter une Catégorie"><img src="../docs/emoticones/task2.jpg" width="40%" alt="Fiche Boisson" > </a>
                            </center>
                            <legend style="color:black; text-align:center;">Vente Journalière </legend>
                        </div>
                        <div class="col-lg-3 col-md-3" style="">
                            <center>
                                 <a href="ficheMensuelleVentePdvG.php" target="_blank" title="Cliquer pour ajouter une Catégorie"><img src="../docs/emoticones/srt3.png" width="40%" alt="Fiche Boisson" > </a>
                            </center>
                            <legend style="color:black; text-align:center;">Vente Mensuelle Boisson</legend>
                        </div>
                        <div class="col-lg-3 col-md-3" style="">
                             <center>
                                 <a href="fichestockBoissBarG.php" target="_blank"><img src="../docs/emoticones/boiss2.png" width="40%" alt="Ajout nourriture" > </a>
                            </center>
                        ...
                        <div class="col-lg-3 col-md-3" style="">
                            ...
                            <center>
                                 <a href="ficheApprovBoissBuvG.php" target="_blank"><img src="../docs/MAJ/form8.png" width="40%" alt="Ajout nourriture" > </a>
                            </center>

...
<html>
    ...
    <body id="" style="font-size: 35px; margin-left: -0px">
        <div class="">
            <div class="col-lg-12" style=" " >
                ...
                <div class="row" style="margin-bottom:10px; margin-left: -20px " >
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <center>
                            <p style="font-family:Century Gothic; font-size:2.3em; text-align:center;">FACTURE</p>
                            
                            <p style="font-family:Century Gothic; font-size:2em; text-align:center;">
                                ETS ASIFIWE B&Z
                            </p>
                            ...
                            <table style="width: 100%" class=" ">
                                ...
                                <tbody style="font-family:arial; font-size:0.9em;">
                                    ...
                                    <tr>
                                        <td>Date :</td>
                                        <td class="text-center"><?php echo date('d/m/Y').':'.date('H:i'); ?></td>
                                    </tr>
                                    <tr>
                                        <td>Serveur:</td>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="row">
                        <div class="row spacer" style="margin-bottom:20px; " >
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <table class="table table-bordered table-striped table-sm" style="font-size: 25px; font-family: arial">
                                    <thead>
                                        <tr>
                                            <th>N°</th>
                                            <th>Désignation</th>
                                            <th>Qté</th>
                                            <th>PU</th>
                                            <th style="width: 400px">Prix Tot</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 400px"><?php echo ($don['ptPanier']+3000000); ?></td>
                    	...
                    	<table class="">
                    		<tr class="">
                                <td class="text-center">
                                   <p class="" style="font-family:Century Gothic; font-size:1.2em;">Total</p> 
                                </td>
                    			<td class="text-center">
	                             ...
	                             ?> 
                                <span><strong> <?php echo number_format((($don['total']+3000000)), 0, ',',' ').' Fc'; ?></strong></span><br>
                    ...
                    <div class="">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 valider">
                                <a href="pages/venteRestaurant.php"><button type="button" class="btn btn-primary">Retour</button></a>
                            </div>

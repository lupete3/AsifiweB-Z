            ...
            <div class="row">
                ...
                <div class="row" style="text-align:center;">
                    <div class="col-md-12 text-center text-uppercase">
                        <h1 style="color:black;  " class="text-center">Rapport Stocks Dépot Rélais 1</h1>
                    </div>
                </div>
                ...
                <div class="container" style="background-color:white; padding: 20px; border-radius:50px; border : 2px solid #b90112" >                   
                    ...
                    <div class="col-lg-12 col-md-12 ">
                        ...
                        <div class="col-lg-3 col-md-3 " style="">
                            <center>
                                 <a href="ficheVenteDepotJourA.php" target="_blank" title="Cliquer pour ajouter une Catégorie"><img src="../docs/emoticones/srt5.jpg" width="40%" alt="Fiche Boisson" > </a>
                            </center>
                ...
                <a style="color:darkblue; font-family: century gothic; font-size: 1em;" href="https://kivufreelance.com" target="_blank">Kivu Fraalance</a>
            </div>

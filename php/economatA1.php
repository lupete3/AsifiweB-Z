            ...
            <div class="row">
                ...
                <div class="row" style="text-align:center;">
                    <div class="col-md-12 text-center text-uppercase">
                        <h1 style="color:black;  " class="text-center">Rapport Stocks Dépot Rélais 2</h1>
                    </div>
                </div>
                ...
                <div class="container" style="background-color:white; padding: 20px; border-radius:50px; border : 2px solid #b90112" >                   
                    ...
                    <div class="col-lg-12 col-md-12 ">
                        ...
                        <div class="col-lg-3 col-md-3" style="">
                            <center>
                                 <a href="ficheStockBoissA1.php" target="_blank" title="Cliquer pour ajouter une Catégorie"><img src="../docs/emoticones/task5.jpg" width="40%" alt="Fiche Boisson" > </a>
                            </center>
                            <legend style="color:black; text-align:center;">Fiche Stock Boisson</legend>
                        </div> 

                       
                        <div class="col-lg-3 col-md-3 " style="">
                            <center>
                                 <a href="ficheVenteDepotJourA1.php" target="_blank" title="Cliquer pour ajouter une Catégorie"><img src="../docs/emoticones/srt5.jpg" width="40%" alt="Fiche Boisson" > </a>
                            </center>
                            <legend style="color:black; text-align:center;">Fiche Vente Journalière</legend>
                        </div> 
                        ...
                        <div class="col-lg-3 col-md-3 " style="">
                             <center>
                                 <a href="ficheApprovBoissA1.php" target="_blank"><img src="../docs/emoticones/new/fichest.png" width="40%" alt="Boisson" > </a>
                            </center>
                        ...
                        <div class="col-lg-3 col-md-3 " style="">
                            ...
                            <center>
                                 <a href="ficheSortieBoissA1.php" target="_blank"><img src="../docs/emoticones/srt.jpg" width="40%" alt="" > </a>
                            </center>
